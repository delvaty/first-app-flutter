...
class MyAppState extends ChangeNotifier {
  ...
  var history = <WordPair>[]; // Historial de palabras

  GlobalKey? historyListKey; // Para manejar la animación de la lista

  void getNext() {
    history.insert(0, current);
    var animatedList = historyListKey?.currentState as AnimatedListState?;
    animatedList?.insertItem(0); // Agrega una nueva palabra animada
